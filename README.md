## Меня зовут Елена, я QA Engineer 👋 ![cat-typing-24](https://github.com/user-attachments/assets/9355b496-8a4d-4e07-b46f-2d96d7ef61e3)
...
- [Моё резюме QA engineer, Тестировщик на HH.ru](https://yuzhno-sakhalinsk.hh.ru/resume/0b9d2f38ff0eeb512d0039ed1f3738666e5a45);
- [Мой сайт](https://elenazapodoynikovaqa.github.io/);

### 👩‍💻 Обо мне:

Совмещаю внимательность к деталям с пониманием системной логики, пишу баги так, чтобы их не пришлось уточнять, соблюдаю этику удалённой работы, точно держу сроки и выстраиваю конструктивную коммуникацию с командой, всегда стремлюсь учиться новому. Считаю, что отсутствие документации и нормальных процессов воспитывает сильных духом тестировщиков:). 
У меня есть хобби: люблю создавать чат-боты любой сложности на языке Python с AI. Один из них для примера: [MetacogniMindBot](https://t.me/MetacogniMind_bot)

🎯 **Мои цели как QA-инженера**:

- Работать в дружной команде профессионалов;
- Участвовать в интересных и значимых проектах;
- Вносить вклад в успех компании;
- Повышать качество цифровых продуктов за счёт грамотного тест-дизайна и глубокой проработки пользовательских сценариев;
- Автоматизировать рутинные задачи и внедрять инструменты, которые ускоряют и улучшают процесс тестирования;
- Продолжать развиваться в направлении API, UI и мобильного тестирования, включая автотесты на Python;
- Участвовать в проектах, где мнение QA действительно влияет на продукт и пользовательский опыт;
- Постепенно двигаться к роли QA-лида, совмещающей техническую экспертизу и управление качеством.

📫 **Cвязаться со мной**:

[![Telegram Badge](https://img.shields.io/badge/-Telegram-blue?style=flat&logo=Telegram&logoColor=white)](https://t.me/Elneuro83)

## 📊 Статистика

![](https://github-readme-stats.vercel.app/api?hide_rank=true&hide=issues,contribs&show_icons=true&locale=en&langs_count=8&card_width=320&username=elenazapodoynikovaQA)
![](https://github-readme-stats.vercel.app/api/top-langs/?layout=donut&langs_count=6&hide_progress=true&username=elenazapodoynikovaQA)

<!-- Выбор темы ↑↑: https://github.com/anuraghazra/github-readme-stats/blob/master/themes/README.md --> 
<!-- Настройка отображения ↑↑: https://github.com/anuraghazra/github-readme-stats/ --> 

![](https://github-readme-activity-graph.vercel.app/graph?&theme=minimal&username=elenazapodoynikovaQA)
